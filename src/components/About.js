  ...
  return (
    ...
    <div>
      ...
      <section className='d-flex flex-column align-items-end justify-content-center'>
        ...
        <p className='MidText overlayText'> Doom scrolling comes with an aftertaste, this is the story of how we plan to take online searches to real-life community through GroupSoup. <br/><br/> <br/> </p>
      </section>
      ...
      <section>
        ...
        <section className='d-flex flex-column flex-md-row align-items-center'>
          <img src={require('../images/Zevez.webp')} className='profile' alt='Founder and Creative Lead, Zevez Zalay'></img>
          <div>
        ...
        <section className='d-flex flex-column flex-md-row align-items-center'>
          <img src={require('../images/Nathan.webp')} className='profile' alt='Founder and Technical Lead, Nathan Jackson'></img>
          <div>
        ...
        <section className='d-flex flex-column flex-md-row align-items-center'>
          <img src={require('../images/Sage.webp')} className='profile' alt='Founder and Systems Lead, Sage Sager'></img>
          <div>  
