...
function About() {
  return (
    <div>
      ...
      <p className='AboutText text-right'> Doom scrolling comes with an <br/> aftertaste, this is the story of how <br/> we plan to take online searches to <br/> real-life community through <br/> GroupSoup. <br/> <br/>  <br/><br/> <br/> </p>
      ...
      <div className='d-flex flex-row align-items-center'>
        <img src={require('../images/Zevez.jpg')} className='profile'></img>
