    ...
    <div>
      ...
      <form>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <input type='text' id='companyNameInput' className='inputBox m-2'></input>
        </div>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <input type='email' id='companyEmailInput' className='inputBox m-2'></input>
        </div>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <input type='email' id='companyPhoneInput' className='inputBox m-2'></input>
        </div>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <input type='email' id='companyAddressinput' className='inputBox m-2'></input>
        </div>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <input type='email' id='companySubjectInput' className='inputBox m-2'></input>
        </div>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <textarea rows="8" id='companyMessageInput' className='m-2'></textarea>
        </div>
        ...
        <div className='d-flex align-items-center justify-content-center'>
          ...
          <textarea rows="4" id='companyHearInput' className='m-2' ></textarea>
        </div>
